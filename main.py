...
def heap_sort(rectangles, background):
    ...
    def heapify(array, size, index):
        ...
        if largest != index:
            rectangles.set_rectangles[index].update_rectangle_in_screen_animation(RED, background, WAIT_HEAP_SORT)
            rectangles.set_rectangles[largest].update_rectangle_in_screen_animation(RED, background, WAIT_HEAP_SORT)
            aux = array[index]
            ...
            rectangles.update_set_rectangles_in_screen_animation(background, WAIT_HEAP_SORT)
